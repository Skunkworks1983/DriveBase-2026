...
public class PathFindingConstants {
  public static LoggedTunableNumber maxVelocityMPS =
      new LoggedTunableNumber("PathFinding/Max Velocity m/s", 3.0);
  public static LoggedTunableNumber maxAccelerationMPSPS =
      new LoggedTunableNumber("PathFinding/Max Acceleration m/s^2", 4.0);
  public static LoggedTunableNumber maxAngularVelocityDPS =
      new LoggedTunableNumber("PathFinding/Max Angular Velocity deg/s", 540);
  ...
  public static PathConstraints buildPathConstraints() {
    ...
    LinearVelocity maxVelocity =
        LinearVelocity.ofBaseUnits(PathFindingConstants.maxVelocityMPS.get(), MetersPerSecond);
